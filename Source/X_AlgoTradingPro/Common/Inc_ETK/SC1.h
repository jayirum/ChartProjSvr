...
// 입력
typedef struct _SC1_InBlock
{
} SC1_InBlock, *LPSC1_InBlock;
#define NAME_SC1_InBlock     "InBlock"

// 출력
typedef struct _SC1_OutBlock
{
...
} SC1_OutBlock, *LPSC1_OutBlock;
#define NAME_SC1_OutBlock     "OutBlock"

...
#define	SERVICENAME		"IRUM_Notifier"
#define DISPNAME		"IRUM_Notifier"
#define DESC			"This service notifies NotifyEmailServer of any log message with notification. This is a test notification log class"

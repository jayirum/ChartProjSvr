...
//BOOL	InitMDRecv();
BOOL	InitMemPool();
//MCAST static unsigned WINAPI RecvMDThread(LPVOID lp);
//MCAST void RecvMDThreadFn();
...
//		if (nLen < 0)
//		{
//			g_log.log(LOGTP_ERR, "MD RECV ERROR:%s", g_pMcastRecv->GetMsg());
//			printf("MD RECV ERROR:%s\n", g_pMcastRecv->GetMsg());
//			g_pMemPool->release(pBuf);
//			Sleep(1000);
//			continue;
//		}
...
//		return FALSE;
//	}
//	g_log.log(LOGTP_SUCC, "멀티캐스트수신 초기화 성공(LOCAL:%s)(MCAST:%s)(PORT:%s)", zLocalIP, zMcastIP, port);
//
//	//TODO 
...
//
//	//// 수신 스레드
//	//MCAST g_hRecvThread = (HANDLE)_beginthreadex(NULL, 0, &RecvMDThread, NULL, 0, &g_unRecvThread);
//
//
//	return TRUE;
//}

...
typedef struct _TC2_OutBlock
{
    ...
    char    cnfr_q              [  12];    // [long  ,   12] 호가확인수량                    StartPos 187, Length 12
    char    rfsl_cd             [   4];    // [string,    4] 호가거부사유코드                StartPos 199, Length 4
    char    text                [ 300];    // [string,  300] 호가거부사유코드명              StartPos 203, Length 300
